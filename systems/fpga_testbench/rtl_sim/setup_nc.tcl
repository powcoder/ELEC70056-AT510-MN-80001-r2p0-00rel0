...
#
#  File Revision       : $Revision: 369125 $
#  File Date           : $Date: 2017-08-11 14:44:16 +0100 (Fri, 11 Aug 2017) $
#
#  Release Information : ARM Internal
#------------------------------------------------------------------------------
#
# Setup script for Cadence Incisive (NCSim)
...
set addr_list [list \
  tb_fpga/u_fpga_top/u_fpga_system/core_cm0_haddr \
...
memory -load -start 0 -datafmt h tb_fpga/uSSRAM1A/bank0 -file itcm0.hex 
memory -load -start 0 -datafmt h tb_fpga/uSSRAM1A/bank1 -file itcm1.hex 
memory -load -start 0 -datafmt h tb_fpga/uSSRAM1A/bank2 -file itcm2.hex 
memory -load -start 0 -datafmt h tb_fpga/uSSRAM1A/bank3 -file itcm3.hex 
                     
memory -load -start 0 -datafmt h tb_fpga/uSSRAM1B/bank0 -file itcm4.hex 
memory -load -start 0 -datafmt h tb_fpga/uSSRAM1B/bank1 -file itcm5.hex 
memory -load -start 0 -datafmt h tb_fpga/uSSRAM1B/bank2 -file itcm6.hex 
memory -load -start 0 -datafmt h tb_fpga/uSSRAM1B/bank3 -file itcm7.hex 

# Preload ZBT memories, (SSRAM2 and 3) to avoid X in read data
memory -load -defval 0 tb_fpga/uSSRAM2/bank0
memory -load -defval 0 tb_fpga/uSSRAM2/bank1
memory -load -defval 0 tb_fpga/uSSRAM2/bank2
memory -load -defval 0 tb_fpga/uSSRAM2/bank3

memory -load -defval 0 tb_fpga/uSSRAM3/bank0
memory -load -defval 0 tb_fpga/uSSRAM3/bank1
memory -load -defval 0 tb_fpga/uSSRAM3/bank2
memory -load -defval 0 tb_fpga/uSSRAM3/bank3
...
# Other commands can be appended below here
